...
class AdminTicketController extends Controller
{
    ...
    public function alltickets(Request $request){
        ...
        $data = Ticket::select('tickets.*',"groupscategories.group_id","groupsusers.users_id")
                ->leftJoin('groupscategories','groupscategories.category_id','tickets.category_id')
                ->leftJoin('groupsusers','groupsusers.groups_id','groupscategories.group_id')
                ->whereNotNull('groupsusers.users_id')
                ->where('groupsusers.users_id', Auth::id())->where('verified','1')->latest('updated_at')->get();
        ...
        if (Auth::user()->getRoleNames()[0] == 'superadmin') {
            dd(Ticket::select('tickets.*',"groupscategories.group_id","groupsusers.users_id")
                ->leftJoin('groupscategories','groupscategories.category_id','tickets.category_id')
                ->leftJoin('groupsusers','groupsusers.groups_id','groupscategories.group_id')
                ->whereNotNull('groupsusers.users_id')
                ->where('groupsusers.users_id', Auth::id())->where('verified','1')->latest('updated_at')->with('user','cust')->get());
        }
        else{
            dd(Ticket::select('tickets.*',"groupscategories.group_id","groupsusers.users_id")
                ->leftJoin('groupscategories','groupscategories.category_id','tickets.category_id')
        ...
        if(request()->ajax()) {
            if (Auth::user()->getRoleNames()[0] == 'superadmin') {
                 Ticket::select('tickets.*',"groupscategories.group_id","groupsusers.users_id")
                ->leftJoin('groupscategories','groupscategories.category_id','tickets.category_id')
                ->leftJoin('groupsusers','groupsusers.groups_id','groupscategories.group_id')
                ->whereNotNull('groupsusers.users_id')
                ->where('groupsusers.users_id', Auth::id())->where('verified','1')->latest('updated_at')->with('user','cust')->get();
               ...
               ->addColumn('action', function($data){
                ...
                $data = Ticket::select('tickets.*',"groupscategories.group_id","groupsusers.users_id")
                ->join('groupscategories','groupscategories.category_id','tickets.category_id')
                ->join('groupsusers','groupsusers.groups_id','groupscategories.group_id')
                ->whereNotNull('groupsusers.users_id')
                ->where('groupsusers.users_id', Auth::id())->where('verified','1')->latest('updated_at')->with('user','cust')->get();
        ...
        return view('admin.viewticket.alltickets',compact('data'));
    }
    ...
    public function activeticket(){
        ...
        if(request()->ajax()) {
                ...
                ->leftJoin('groupsusers','groupsusers.groups_id','groupscategories.group_id')
                ->whereNotNull('groupsusers.users_id')
                ->where('groupsusers.users_id', Auth::id())->where('verified','1')->whereIn('status', ['New', 'Re-Open','Inprogress'])->with('user','cust')->latest('updated_at')->get();
    ...
    public function onholdticket(){
        ...
        if(request()->ajax()) {
               ...
               ->addColumn('action', function($data){
                ...
                return view('admin.assignedtickets.onholdtickets');
    }

                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex end">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                ...
                                                <small >  A new ticket has been created <strong> {{ $notification->data['ticket_id'] }} </strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex end">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                <a href = "{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                    <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>                                                            
                                                    <small >  This ticket has been closed <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex end">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                <a href = "{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                    <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>                                                            
                                                    <small >  This ticket status is On-Hold <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex end">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                <a href = "{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                    <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>                                                            
                                                    <small >  This ticket status is overdue <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

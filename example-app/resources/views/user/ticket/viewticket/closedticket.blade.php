												...
												<div class="card mb-0">
													...
													<div class="card-body">
														<div class="table-responsive">
															...
															<table
																class="table table-vcenter text-nowrap table-bordered supportticket-list table-striped w-100"
																id="closedtickets">
																<thead>
																	<tr>
						...
						if (willDelete) {
							$.ajax({
								...
								success: function (data) {
									...
									$('#closedtickets').DataTable().ajax.reload();
								},
								error: function (data) {

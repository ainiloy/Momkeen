                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="me-3  mt-1 d-block">
                                                    ...
                                                    <small>  Your new ticket has been created <strong>{{ $notification->data['ticket_id'] }}</strong> </small></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card readmores mb-3">
                                    <div class="card-body p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                <a href = "{{$notification->data['link']}}" data-id="{{ $notification->id }}"><p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }}</span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small>  Your ticket has been closed<strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card readmores mb-3">
                                    <div class="card-body p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                <a href = "{{$notification->data['link']}}" data-id="{{ $notification->id }}"><p class="mb-0 fs-13 mark-as-read"> <span class="font-weight-semibold"> {{ $notification->data['title'] }}</span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small>  Your ticket status is On-Hold <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card readmores mb-3">
                                    <div class="card-body p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="me-3  mt-1 d-block">
                                                <a href = "{{$notification->data['link']}}" data-id="{{ $notification->id }}"><p class="mb-0 fs-13 mark-as-read"> <span class="font-weight-semibold">{{ $notification->data['title'] }}</span><span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small>  Your ticket status is overdue <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card readmores mb-3">
                                        <div class="card-body p-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="me-3  mt-1 d-block">
                                                    <a href = "{{$notification->data['link']}}" data-id="{{ $notification->id }}"><p class="mb-0 fs-13 mark-as-read"> <span class="font-weight-semibold">{{ $notification->data['title'] }}</span><span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                    <small>  This ticket has been reopened <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card readmores mb-3">
                                        <div class="card-body p-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="me-3  mt-1 d-block">
                                                    <a href = "{{$notification->data['link']}}" data-id="{{ $notification->id }}"><p class="mb-0 fs-13 mark-as-read"> <span class="font-weight-semibold">{{ $notification->data['title'] }}</span><span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                    <small>  You got a new reply on this ticket <strong> {{ $notification->data['ticket_id'] }}</strong> </small></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body h-100 w-100">
                                    <div class="main-content text-center">
                                        ...
                                        <h4 class="mb-1">There are no new notifications to display</h4>
                                        <p class="text-muted">There are no notifications. We will notify you when the new notification arrives.</p>
                                    </div>
                                </div>  
                            </div>
                            @endforelse

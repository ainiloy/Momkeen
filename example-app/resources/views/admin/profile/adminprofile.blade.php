		...
		@endsection
							...
							<div class="row">
								<div class="col-xl-3 col-lg-4 col-md-12">
											...
											<div class="user-pic text-center">
												...
												<div class="pro-user mt-3">
													...
													<div class="btn-list">
														...
														<a href="{{url('admin/profile/edit')}}" class="btn btn-secondary mt-3">Edit Profile</a>
									...
									<div class="card">
										<div class="card-header border-0">
											<h4 class="card-title"> Personal Setting</h4>
										</div>
										<div class="card-body">
											<div class="switch_section">
												<div class="switch-toggle d-flex mt-4">
													...
													<label class="form-label ps-3"> Switch to Dark-Mode </label>
												</div>
											</div>
										</div>
									</div>
		...
		<script type="text/javascript">
			...
			(function($)  {
				...
				$('.sprukoswitch').on('change', function() {
					var dark = $('#myonoffswitch181').prop('checked') == true ? '1' : '0';

		...
		@endsection
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2">Assigned Tickets</span></h4>
								</div>
							</div>
							<!--End Page header-->
								...
								<div class="card ">
									...
									<div class="card-body" >
										<div class="table-responsive spruko-delete">
											...
											<table class="table table-vcenter text-nowrap table-bordered table-striped ticketdeleterow w-100" id="assignedticket">
												<thead >
													<tr>
														<th >Id</th>
														<th >Si No</th>
